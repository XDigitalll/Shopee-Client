...
export const metadata: Metadata = {
  title: "Termos de Uso",
  description: "Condições gerais para usar os serviços de compra assistida internacional da ShopeeMz em Moçambique. Direitos e responsabilidades do cliente e da plataforma.",
  openGraph: {
    title: "Termos de Uso",
    description: "Tudo o que precisas de saber antes de usar os serviços de compra assistida internacional da ShopeeMz em Moçambique.",
  },
};
...
export default function TermsPage() {
  return (
    <LegalPage
      eyebrow="Termos"
      title="Termos de Uso"
      description="Estes termos regulam a relação entre ti e a ShopeeMz no âmbito dos serviços de compra assistida internacional. Ao usar a plataforma, confirmas que leste, compreendeste e aceitaste todas as condições aqui descritas."
      updatedAt="23 de maio de 2026"
      sections={[
        {
          title: "1. Quem somos e o que fazemos",
          bodyLines: [
            "A ShopeeMz é uma plataforma moçambicana de compra assistida internacional. Actuamos como intermediários: recebemos os teus pedidos, pesquisamos produtos, preparamos cotações, processamos pagamentos e coordenamos a importação e entrega em Moçambique.",
        ...
        },
        {
          ...
          items: [
            ...
            "Ao registares-te com Google, autorizas a ShopeeMz a receber o teu email, nome e foto de perfil do Google.",
        ...
        },
        {
          ...
          items: [
            ...
            "A ShopeeMz analisa o pedido, verifica disponibilidade, calcula custos e emite uma cotação.",
        ...
        },
        {
          ...
          items: [
            ...
            "Após submissão do comprovativo, o pagamento é verificado manualmente pela equipa da ShopeeMz.",
            "Não processamos pedidos sem confirmação de pagamento válido. A ShopeeMz não assume responsabilidade por valores enviados para contas ou números não indicados oficialmente pela plataforma.",
            "Em caso de falha de pagamento por parte do fornecedor ou cancelamento após pagamento confirmado, a ShopeeMz devolve o valor pago conforme a política de reembolsos.",
          ],
        },
        {
          ...
          bodyLines: [
            ...
            "Se ocorrer variação cambial significativa (superior a 3%) entre a cotação e o momento da compra, a ShopeeMz notificar-te-á e poderá emitir nova cotação. Tens o direito de cancelar sem penalização neste caso.",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            "A ShopeeMz reserva-se o direito de recusar qualquer pedido sem necessidade de justificação detalhada quando houver suspeita de ilegalidade ou risco para a operação.",
          ],
        },
        {
          title: "9. Importação e alfândega",
          bodyLines: [
            "A ShopeeMz actua como importador por conta do cliente. Os produtos são sujeitos às leis alfandegárias moçambicanas, incluindo o Código Aduaneiro (Decreto n.º 46/2002 e legislação subsequente). Taxas alfandegárias, IVA na importação e outros direitos aduaneiros são estimados na cotação mas podem variar conforme a classificação definitiva da mercadoria pelas autoridades.",
            "Em caso de retenção alfandegária por documentação incompleta ou classificação contestada, a ShopeeMz envidará esforços para resolver a situação, mas não pode garantir a libertação da mercadoria nem se responsabiliza por taxas adicionais impostas pelas autoridades alfandegárias.",
        ...
        },
        {
          ...
          bodyLines: [
            ...
            "A ShopeeMz informa actualizações relevantes (chegada ao país, retenção alfandegária, saída para entrega) através das notificações da plataforma e/ou WhatsApp.",
            "Atrasos causados por eventos fora do controlo da ShopeeMz (ver cláusula de força maior) não conferem direito a compensação, mas a ShopeeMz compromete-se a manter o cliente informado e a explorar alternativas.",
          ],
        },
        {
          title: "11. Entrega local",
          items: [
            "A entrega é feita pelo estafeta designado pela ShopeeMz na morada confirmada pelo cliente.",
            "O cliente deve confirmar a morada de entrega quando o pedido atingir o estado 'Chegou' ou 'Pronto para entrega'.",
            "Em caso de ausência na morada no momento da entrega, o estafeta tentará contactar o cliente. Se não for possível concluir a entrega, o pedido volta para a sede da ShopeeMz e é agendada nova tentativa.",
            "Após duas tentativas falhadas por motivo imputável ao cliente (ausência, morada incorrecta, recusa de recepção), a ShopeeMz pode cobrar taxa adicional de reentrega.",
          ],
        },
        {
          ...
          bodyLines: [
            ...
            "A ShopeeMz pode cancelar pedidos com dados falsos, produtos proibidos, comportamento abusivo, pagamento não confirmado dentro do prazo ou tentativa de fraude.",
          ],
          items: [
            ...
            "Cancelamento após compra ao fornecedor mas antes do envio: reembolso sujeito à política de devolução do fornecedor, deduzidas as taxas de serviço da ShopeeMz.",
        ...
        },
        {
          ...
          items: [
            "Se o produto recebido for diferente do descrito pelo fornecedor, deves reportar à ShopeeMz no prazo de 48 horas após a recepção, com fotos detalhadas do produto e da embalagem.",
            "A ShopeeMz analisará o caso e, conforme aplicável, abrirá disputa com o fornecedor, procederá à reentrega de produto correcto ou emitirá reembolso parcial ou total.",
        ...
        },
        {
          ...
          bodyLines: [
            "A ShopeeMz responde pelos seus actos enquanto intermediária: negligência no processo de cotação, falha em notificar alterações materiais de preço, ou erro nos dados de entrega imputável à plataforma.",
            "A ShopeeMz não é responsável por: variações de preço ou câmbio após cotação aceite, atrasos de fornecedores ou transportadoras internacionais, retenções ou taxas alfandegárias, indisponibilidade de stock após compra, danos de produto causados no transporte internacional, ou informação incorrecta fornecida pelo cliente.",
            "Em qualquer caso, a responsabilidade máxima da ShopeeMz perante um cliente por pedido não excederá o valor total pago por esse pedido.",
          ],
        },
        {
          title: "16. Força maior",
          body: "A ShopeeMz não será responsabilizada por atrasos ou incumprimento causados por eventos fora do seu controlo razoável, incluindo: pandemias, catástrofes naturais, greves, suspensão de voos, bloqueios alfandegários por política governamental, guerras, sanções internacionais ou falha de infraestrutura crítica de telecomunicações ou energia. Em caso de força maior, a ShopeeMz notificará os clientes afectados o mais rapidamente possível e explorará alternativas dentro do possível.",
        },
        {
          title: "17. Prevenção de fraude",
          bodyLines: [
            "A ShopeeMz monitoriza activamente tentativas de fraude, incluindo comprovativos de pagamento falsificados, uso de múltiplas contas para contornar limites, e pedidos com dados de entrega inconsistentes.",
        ...
        },
        {
          ...
          body: "Todo o conteúdo da plataforma ShopeeMz — incluindo marca, logótipo, design, textos, imagens e código — é propriedade da ShopeeMz ou de seus licenciantes. Não podes reproduzir, distribuir ou criar obras derivadas sem autorização escrita prévia.",
        },
        {
          title: "19. Modificações ao serviço e aos termos",
          bodyLines: [
            "A ShopeeMz pode modificar funcionalidades, preços de serviço, prazos operacionais ou processos com notificação prévia de 15 dias para alterações materiais.",
            "A continuação do uso da plataforma após o período de notificação constitui aceitação das alterações. Para alterações de preço de serviço que afectem pedidos em curso, a ShopeeMz aplicará o preço anterior até à conclusão desses pedidos.",
          ],
        },
        {
          title: "20. Suspensão e encerramento de conta",
          items: [
            "A ShopeeMz pode suspender ou encerrar contas por: violação destes termos, comportamento abusivo para com a equipa, fornecimento de informação falsa, tentativa de fraude ou inactividade prolongada.",
