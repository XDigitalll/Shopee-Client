...
export const metadata: Metadata = {
  ...
  description: "Como funcionam entregas ShopeeMz em Maputo e provincias.",
};
      ...
      sections={[
        ...
        },
        {
          ...
          items: [
            ...
            "Prazos apresentados sao estimativas e podem mudar por factores fora do controlo da ShopeeMz.",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            "Se a falha for da operacao ShopeeMz ou do estafeta, faremos nova coordenacao sem custo adicional quando aplicavel.",
