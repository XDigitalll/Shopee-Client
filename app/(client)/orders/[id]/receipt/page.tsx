          ...
          <div className="space-y-6">
            ...
            <article className="min-w-0 rounded-[24px] border p-4 sm:rounded-[28px] sm:p-5" style={{ borderColor: "#F2D4CC" }}>
              ...
              <div className="mt-4 space-y-3 text-sm">
                ...
                <div className="receipt-info-row flex items-start justify-between gap-4"><span className="min-w-0 break-words" style={{ color: "#6B7280" }}>Referencia</span><strong className="min-w-0 break-all text-right" style={{ color: "#1A1410" }}>{order?.payment?.transactionId || order?.payment?.providerReference || "--"}</strong></div>
